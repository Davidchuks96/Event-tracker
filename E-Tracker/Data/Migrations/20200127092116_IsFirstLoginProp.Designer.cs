...
namespace E_Tracker.Data.Migrations
{
    ...
    [Migration("20200127092116_IsFirstLoginProp")]
    partial class IsFirstLoginProp
    {
            ...
            modelBuilder.Entity("E_Tracker.Data.ItemType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1adc9531-81c2-405c-a97a-bfc4359c09f7",
                            DateCreated = new DateTime(2020, 1, 27, 10, 21, 14, 126, DateTimeKind.Local).AddTicks(8807),
                            IsActive = true,
                            Name = "Renewal"
                        },
                        new
                        {
                            Id = "47641c15-dd2b-412b-b7bd-e99de2d654c5",
                            DateCreated = new DateTime(2020, 1, 27, 10, 21, 14, 128, DateTimeKind.Local).AddTicks(1002),
                            IsActive = true,
                            Name = "Servicing"
                        });
                });
