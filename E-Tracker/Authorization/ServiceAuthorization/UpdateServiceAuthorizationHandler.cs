...
{
    public class UpdateServiceAuthorizationHandler : AuthorizationHandler<AccountAuthorizationRequirement>
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, AccountAuthorizationRequirement requirement)
        {
            ...
            if (context.User.HasClaim(CustomClaims.Permission, CustomClaimsValues.UpdateService)) context.Succeed(requirement);
