...
{
    public class ApproveServiceAuthorizationHandler : AuthorizationHandler<AccountAuthorizationRequirement>
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, AccountAuthorizationRequirement requirement)
        {
            ...
            if (context.User.HasClaim(CustomClaims.Permission, CustomClaimsValues.ApproveService)) context.Succeed(requirement);
