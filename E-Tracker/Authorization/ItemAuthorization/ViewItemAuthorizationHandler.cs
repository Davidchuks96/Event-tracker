...
{
    public class ViewItemAuthorizationHandler : AuthorizationHandler<AccountAuthorizationRequirement>
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, AccountAuthorizationRequirement requirement)
        {
            ...
            if (context.User.HasClaim(CustomClaims.Permission, CustomClaimsValues.ViewItem)) context.Succeed(requirement);
